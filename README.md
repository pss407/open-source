...
## <H3>3. 개발 동기 및 과정</H3>
- 개발동기<br>
  1. 오픈소스 프로젝트를 진행하게 되면서 현재 주제 이전에 주제에서 git을 이용한 Markdown을 사용하였습니다.<br>
  2. git에서의 Markdown의 경우 사용하고자 하는 문법을 구글에 검색해가며 사용해야하며, 또 git에서는
  지원하지 않는 문법이 존재하여 다른 문법을 찾아보는 등 다양한 어려움이 있었습니다.<br>
  3. 미리보기 지원의 경우에는 Commit을 하여 첫 프로젝트 화면 창에 뜨는 경우를 봐야한다거나 또는 Preview 
  창을 들어감으로써 확인해야하는 불편함이 존재하였습니다.<br>
  4. Markdown의 편리함을 git을 사용하는 개발자들에게 제공하고자 이 오픈소스를 개발하게 되었습니다.<br>
...
- 개발과정
  ...
  검색하였습니다.<br>
  4. Vscode에서 Markdown을 사용하고 이를 바로 word형식으로 저장해주는 오픈소스를 검색하였습니다.<br>
  5. 위의 오픈소스를 가지고 사용시 간략한 설명문 및 사용방법을 한글화로 코드를 개선하여 좀 더
  사용자가 편리하게 이용하게끔 수정하였습니다.<br>
