...
- 개발동기
  ...
  1. 오픈소스 프로젝트를 진행하게 되면서 현재 주제 이전 주제에서 
     git을 이용한 Markdown을 사용하였습니다.
  
  2. git에서의 Markdown의 경우 사용하고자 하는 문법을 구글에 검색해가며 사용해야하며, 
     또 git에서는 지원하지 않는 문법이 존재하여 다른 문법을 찾아보는 등 다양한 어려움이 있었습니다.
  
  3. 미리보기 지원의 경우에는 Commit을 하여 첫 프로젝트 화면 창에 뜨는 경우를 봐야한다거나
    또는 Preview 창을 들어감으로써 확인해야하는 불편함이 존재하였습니다.
  
  4. Markdown의 편리함을 git을 사용하는 개발자들에게 제공하고자 이 오픈소스를 개발하게 되었습니다.
...
### <H4>이 오픈소스를 사용하고자 하는 SW개발자에 도움이 되는 것
    ...
    4. Preview를 오프라인 상황에서도 제공하므로 별도의 네트워크 연결이 없이도 코드 작성이 가능하고 더불어 문서화 가능하다.
        ...
        에서도 Preview를 활용하면서 Markdown 작업을 핳 수 있다.
