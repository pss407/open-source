...
3. 기능 설명 한글화
    - 기존에 영어로 되어있던 함수 설명, 기능 설명 등을 한글화하여, 평소 영어 해석에 어려움을 느꼈던 
      사용자도 손쉽게 기능 이해
...
![Alt Text](https://user-images.githubusercontent.com/43747079/50043120-0c2d8800-00b2-11e9-838e-7772791d6323.png){: width="300" height="100"}
